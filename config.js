...
module.exports = {
    ...
    ownerNumber: ['91xxxxxxxxxxx','994775748404'], // Add your number without + or spaces (e.g., 919876543210)
    ownerName: ['NexusMD ⚡', 'XaOs_KoLgE'], // Owner names corresponding to ownerNumber array
